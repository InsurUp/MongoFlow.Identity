    ...
    where TKey : IEquatable<TKey>
{
    ...
    public IDocumentSet<TUser> Users { get; set; } = null!;
    public IDocumentSet<TRole> Roles { get; set; } = null!;
    public IDocumentSet<MongoUserToken<TKey>> UserTokens { get; set; } = null!;
}